...
public:
    ...
    typedef std::function<void(std::shared_ptr<std::vector<uint8_t>> frame)> AUDIO_FRAME_CALLBACK;
    ...
    void set_audio_callback(AUDIO_FRAME_CALLBACK cb);
    void set_audio_enabled(bool enable);
